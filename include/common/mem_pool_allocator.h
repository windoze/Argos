...
#define Argos_mem_pool_allocator_h
...
namespace argos {
    namespace common {
        ...
        struct mem_pool_tl_allocator : public mem_pool_allocator<T>
        {
            ...
            typedef size_t size_type;
            typedef int64_t difference_type;
            template<class U> struct rebind { typedef mem_pool_tl_allocator<U> other; };
...
template<typename T>
inline void *operator new(size_t sz, argos::common::mem_pool_allocator<T> allocator)
{
...
template<typename T>
inline void *operator new(size_t sz, argos::common::mem_pool_tl_allocator<T> allocator)
{
    return allocator.allocate(sz);
}
...
/*
template<typename T>
inline void operator delete(void *p, argos::common::mem_pool_allocator<T> allocator)
{
